...
>
  ...
  <div className="relative">
    <input
      ...
      className="pl-10 pr-4 py-2 rounded-full bg-white text-sm text-gray-800 border border-purple-300 focus:outline-none focus:ring-2 focus:ring-purple-500 shadow-md transition-all duration-300 w-72 sm:w-96"
    />
